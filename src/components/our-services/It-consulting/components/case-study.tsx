...
import { CaseStudyItem } from "./components/case-study-item.tsx";
...
export const CaseStudy: React.FC = () => {
  ...
  return (
    <div className="flex flex-col mt-20 px-14 md:px-20 ">
      <div className="flex flex-col">
        <h2 className="custom-heading-style lg:lg-custom-heading-style">
          Case Studies
        </h2>
      </div>
      <div className="mt-10 w-full xs:flex xs:overflow-x-auto xs:space-x-4 md:grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-10 mb-4 md:overflow-hidden scrollbar-hide">
        {data.map((item, index) => (
